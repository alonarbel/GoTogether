...
-- ============================================================
-- Cancelled cards (min_deadline passed, minimum not reached)
-- ============================================================
insert into public.travel_cards (id, user_id, title, description, type, organizer_role, address, city, country, min_participants, max_participants, event_date, event_time, min_deadline, contact_info, phone, status)
values
  (
    'cccccccc-0000-0000-0000-000000000006',
    'aaaaaaaa-0000-0000-0000-000000000001',
    'טיול לנחל עיון — בוטל',
    'טיול יום בנחל עיון בגליל העליון — מפל תנור ומפל טנטור. לא הגענו למינימום משתתפים.',
    'trip', 'traveler',
    'נחל עיון', 'קרית שמונה', 'ישראל',
    5, 12,
    (current_date - interval '3 days')::date,
    '07:30',
    (current_date - interval '5 days')::date,
  ...
  (
    ...
    'aaaaaaaa-0000-0000-0000-000000000003',
    'סדנת בישול מרוקאי — בוטלה',
    'ערב של בישול מרוקאי קלאסי — מרק חריסה, כוסכוס וסמבוסק. לא הגענו ל-6 משתתפים הדרושים.',
    'workshop', 'organizer',
    'שוק הכרמל', 'תל אביב', 'ישראל',
    6, 10,
    (current_date - interval '7 days')::date,
  ...
  (
    ...
    'aaaaaaaa-0000-0000-0000-000000000002',
    'ריצת בוקר בפארק הירקון — בוטלה',
    'ריצה קבוצתית של 10 ק"מ לאורך הירקון. לא מצאנו מספיק רצים.',
    'sport', 'traveler',
...
-- Participants for cancelled cards (below minimum)
insert into public.participants (card_id, user_id)
values
  -- נחל עיון: only 2 of 5 minimum
  ...
  -- סדנת בישול: only 2 of 6 minimum
  ...
  -- ריצת בוקר: only 3 of 8 minimum
  ('cccccccc-0000-0000-0000-000000000008', 'aaaaaaaa-0000-0000-0000-000000000002'),
  ('cccccccc-0000-0000-0000-000000000008', 'aaaaaaaa-0000-0000-0000-000000000003'),
